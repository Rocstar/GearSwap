...
--[[ Start Message ]]--
  ...
  add_to_chat(200, 'Gearswap: Engaged DD ( ALT F9 ) Idle Refresh ( F9 )') 
...
--[[ Fast Cast ]]--
  ...
  pre.cast = {ammo="Impatiens",head="Haruspex Hat",
    ...
    ring2="Veneficium Ring",back="Swith Cape",
    waist="Witful Belt",legs="Orvail Pants +1",
    feet="Chelona Boots +1"} 

--[[ Cure Spellcasting ]]--

  pre.Cure = {head="Cleric's Cap +2",neck="Aceso's Choker",
    body="Heka's Kalasiris",ring1="Prolix Ring",
    ring2="Veneficium Ring",back="Pahtli Cape",
    waist="Capricornian Rope",legs="Nabu's Shalwar",
    feet="Cure Clogs"} 
...
--[[ Midcast Dark ]]--
  mid.Dark_Magic = {main="Eminent Staff",sub="Zuuxowu Grip",
    ammo="Memoria Sachet",head="Espial Cap",
    neck="Orison Locket",ear1="Gifted Earring",
    ear2="Loquacious Earring",body="Espial Gambison",
    hands="Espial Cuffs",ring1="Prolix Ring",
    ring2="Veneficium Ring",back="Swith Cape",
...
--[[ Refresh ]]--
  ...
  REF = {main="Terra's Staff",sub="Oneiros Grip",
    ammo="Incantor Stone",head="Wivre Hairpin",
