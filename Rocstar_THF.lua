...
head="Lithelimb Cap",neck="Love Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
body="Manibozho Jerkin",hands="Plunderer's Armlets +1",ring1="Epona's Ring",ring2="Cho'j Band",
...
regen = set_combine(engaged, {neck="Wiglen Gorget",
ring1="Paguroidea Ring",ring2="Sheltered Ring",
back="Iximulew Cape"}) 

max_regen = set_combine(engaged, {head="Ocelomeh Headpiece +1",
neck="Wiglen Gorget",
ring1="Paguroidea Ring",ring2="Sheltered Ring",
back="Iximulew Cape"}) 
...
step = set_combine(acc, {hands="Plunderer's Armlets +1",
 ...
 elseif new == 'Idle' then 
  if player.hpp <= 75 then 
   ...
   if movement_feet ~= false then 
    equip(idle,({feet="Skadi's Jambeaux"})) 
   else 
    equip(idle) 
   end 
 end 
